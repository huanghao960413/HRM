                    ...
                    <tr>
                        ...
                        <td>
                            <c:if test="${requestScope.wage.w_state==0}">
                                <a class="layui-btn layui-btn-sm" href="staff/wageReviewAdd?w_id=${requestScope.wage.w_id}">薪资复议</a>
                            </c:if>
                            <c:if test="${requestScope.wage.w_state==1}">
                                <a class="layui-btn layui-btn-sm" href="staff/wageReviewShow?w_id=${requestScope.wage.w_id}">查看复议</a>
                            </c:if>
