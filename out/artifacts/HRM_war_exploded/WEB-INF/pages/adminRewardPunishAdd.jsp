...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            <form action="adminRewardPunishAddDo" method="post">
                <table>
                    <tr>
                        <td>部门:</td>
                        <td>
                    ...
                    <tr>
                        <td>日期:</td>
                        <td><input type="date" name="rp_date"/></td>
                    </tr>
                    <tr>
                        <td>原因:</td>
                        <td><input type="text" name="rp_message"/></td>
                    </tr>
                    <tr>
                        <td>金额:</td>
                        <td><input type="text" name="rp_money"/></td>
                    </tr>
                    <tr>
                        <td>状态:</td>
                        <td>
                            <select name="rp_state">
