        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                <li class="layui-nav-item layui-nav-itemed">
                    <a class="" href="javascript:;">员工培训</a>
                    <dl class="layui-nav-child">
                        <dd><a href="staff/trainRecordShow">培训信息</a></dd>
                    </dl>
                </li>
            </ul>
        </div>
                        ...
                        <table cellspacing="0px">
                            ...
                            <tr>
                                ...
                                <td style="text-align: right">
                                    ...
                                    <c:if test="${requestScope.recordList[loop.count-1].tr_state==1}">
                                        培训结束
                                    </c:if>
                                </td>
                            </tr>
                ...
                <table>
                    <tr>
                        <td><a class="layui-btn layui-btn-sm"
                               href="staff/trainRecordShow?currentPage=1">首页</a></td>
                        <c:if test="${requestScope.currentPage != 1}">
                            <td><a class="layui-btn layui-btn-sm"
                                   href="staff/trainRecordShow?currentPage=${requestScope.currentPage - 1}"><</a>
                            </td>
                        </c:if>
                        <c:forEach var="i" begin="1" end="${requestScope.totalPages}">
                            <td><a class="layui-btn layui-btn-sm"
                                   href="staff/trainRecordShow?currentPage=${i}">${i}</a>
                            </td>
                        </c:forEach>
                        ...
                        <td><a class="layui-btn layui-btn-sm"
                               href="staff/trainRecordShow?currentPage=${requestScope.totalPages}">尾页</a>
                        </td>
                    </tr>
                </table>
            </c:if>
