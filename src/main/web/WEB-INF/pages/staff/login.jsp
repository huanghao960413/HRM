    ...
    <form action="staff/loginDo" method="post">
        <div class="loginBox">
            ...
            <div class="loginBoxCenter">
                ...
                <p><input type="text" id="username" name="s_name" class="loginInput" autofocus="autofocus"
                          required="required" autocomplete="off" placeholder="请输入用户名" value=""/></p>
                <!-- required 规定必需在提交之前填写输入字段-->
                <p><label for="password">密码：</label></p>
                <p><input type="password" id="password" name="s_pass" class="loginInput" required="required"
