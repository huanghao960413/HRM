    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            ...
            <c:if test="${requestScope.totalPages > 0}">
                <table>
                    <tr>
                        <td><a class="layui-btn layui-btn-sm" href="adminPositionShow?currentPage=1">首页</a></td>
                        <c:if test="${requestScope.currentPage != 1}">
                            <td><a class="layui-btn layui-btn-sm"
                                   href="adminPositionShow?currentPage=${requestScope.currentPage - 1}"><</a></td>
                        </c:if>
                        <c:forEach var="i" begin="1" end="${requestScope.totalPages}">
                            <td><a class="layui-btn layui-btn-sm" href="adminPositionShow?currentPage=${i}">${i}</a>
                            </td>
                        </c:forEach>
                        ...
                        <td><a class="layui-btn layui-btn-sm"
                               href="adminPositionShow?currentPage=${requestScope.totalPages}">尾页</a></td>
                    </tr>
                </table>
            </c:if>
        </div>
