...
<body>
<div class="wrapper">
    <form action="visitor/registerDo" method="post">
        <div class="loginBox">
            ...
            <div class="loginBoxCenter">
                ...
                <a id="v_pass_msg"></a>
                <p><label for="password2">再次输入密码：</label></p>
                <p><input type="password" id="password2" name="v_pass2" class="loginInput" required="required"
                          placeholder="再次输入密码" value=""/></p>
                <a id="v_pass2_msg"></a>
                <p><a style="color: red">${requestScope.msg}</a></p>
            </div>
            <div class="loginBoxButtons">
                <input class="loginBtn" type="submit" value="注册" onclick="return add()">
            </div>
        </div>
    </form>
</div>
